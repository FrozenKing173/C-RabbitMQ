 ...
 * Date: 7 March 2018
 * Project: ContactDetailsServiceA
 * Description: This project will initiate RPC Client service for sending and receiving name messages.
 *              
 *              I hope you enjoy reading my code and thanks for the challenge on RabbitMQ.
 */

namespace ContactDetailsServiceA
{
    class Program
    {
